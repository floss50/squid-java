...
public interface AssetsAPI {
    ...
    public Boolean consume( String serviceDefinitionId, String serviceAgreementId, DID did, Account consumerAccount, String basePath, int threshold);
    public Boolean consume( String serviceDefinitionId, String serviceAgreementId, DID did, Account consumerAccount, String basePath);
    Flowable<AccessConditions.AccessGrantedEventResponse> order(DID did, String serviceDefinitionId, Account consumerAccount, String serviceAgreementId);
